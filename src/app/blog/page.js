...
export const metadata = buildMetadata({
  title: "Dental Blog With Oral Health Tips for Noida Patients",
  description:
    "Read dental blog articles from CrystalFloss Dental Clinic in Noida covering teeth cleaning, cosmetic dentistry, kids dental care, root canal treatment, and emergency oral health advice.",
  path: "/blog",
  keywords: [
    "dental blog Noida",
    "oral health tips Noida",
