...
export const metadata = buildMetadata({
  ...
  description:
    "Read common dental questions about checkups, cosmetic treatment, emergency dentistry, kids dental visits, root canal care, and appointment planning at CrystalFloss Dental Clinic in Noida.",
  path: "/faq",
  keywords: [
    "dental faq in Noida",
...
const faqColumns = [
  [
    ...
    },
    {
      ...
      answer:
        "Yes. Family scheduling is one of the reasons many Noida patients choose our clinic, especially for routine preventive visits and follow-ups.",
    },
  ],
  [
    {
      ...
      <section className="section-shell px-4 sm:px-6 md:px-8">
        <div className="site-shell">
          <div className="section-heading">
            ...
            <h2 className="section-title">Useful answers for patients comparing dentists in Noida.</h2>
