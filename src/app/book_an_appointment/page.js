...
export const metadata = buildMetadata({
  title: "Book a Dental Appointment in Noida",
  description:
    "Book a dental appointment at CrystalFloss Dental Clinic in Noida for checkups, teeth cleaning, cosmetic dentistry, kids dental care, second opinions, and urgent treatment.",
  path: "/book_an_appointment",
  keywords: [
    "book dentist appointment in Noida",
    "online dental booking Noida",
    "emergency dental appointment Noida",
  ],
});
        ...
        <div className="site-shell grid gap-8 lg:grid-cols-[0.88fr_1.12fr]">
          <div className="rounded-[2rem] bg-[#16313b] px-7 py-8 text-white sm:px-9">
            ...
            <p className="mt-5 text-[16px] leading-8 text-white/74">
              This page now speaks more directly to patients searching for a dentist in Noida, whether they need a
