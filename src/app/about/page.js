...
export const metadata = buildMetadata({
  title: "About CrystalFloss Dental Clinic in Noida",
  description:
    "Learn about CrystalFloss Dental Clinic in Noida, our patient-first approach, experienced dentists, modern diagnostics, and personalized family and cosmetic dental care.",
  path: "/about",
  keywords: [
    "about dental clinic in Noida",
    "experienced dentist team in Noida",
    "family dental clinic Noida",
    "patient-first dentist in Noida",
  ],
});

const aboutFaqs = [
  {
    question: "What makes CrystalFloss Dental Clinic different from other dental clinics in Noida?",
    answer:
        ...
        <div className="site-shell grid items-center gap-12 lg:grid-cols-[0.95fr_1.05fr]">
          <div className="relative mx-auto w-full max-w-[560px]">
            ...
            <div className="card-surface relative overflow-hidden rounded-[2rem] p-4">
              <div className="overflow-hidden rounded-[1.6rem]">
                <Image
                  src="/about-img.png"
                  alt="Dentist explaining treatment options to a patient at CrystalFloss Dental Clinic"
                  width={560}
                  height={640}
          ...
          <div>
            ...
            <p className="section-copy max-w-[640px]">
              CrystalFloss Dental Clinic serves Noida families with a better kind of dental experience: one that balances
        ...
        <div className="site-shell grid gap-6 lg:grid-cols-[0.95fr_1.05fr] justify-center">
          ...
          <div className="card-surface p-6 sm:p-7">
            ...
            <h2 className="mt-4 text-[32px] font-semibold leading-tight text-[#16313b]">
              More about how we care for families in Noida
            </h2>
            <div className="mt-8">
