...
export const metadata = buildMetadata({
  title: "Dental Services in Noida for Family, Cosmetic and Emergency Care",
  description:
    "Explore dental services at CrystalFloss Dental Clinic in Noida including checkups, cleaning, cosmetic dentistry, root canal treatment, kids dental care, restorative work, and emergency support.",
  path: "/services",
  keywords: [
...
const services = [
  ...
  },
  {
    ...
    details:
      "Cosmetic dentistry at CrystalFloss is built around proportion, facial harmony, and realistic outcomes. We help patients understand which changes will make the biggest difference without over-treatment.",
    includes: [
...
const serviceFaqs = [
  {
    question: "Which dental services do you offer at CrystalFloss Dental Clinic in Noida?",
    answer:
