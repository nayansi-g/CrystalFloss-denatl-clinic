export const clinic = {
  name: "CrystalFloss Dental Clinic",
  shortName: "CrystalFloss",
  url: "https://www.CrystalFlossdentalclinic.com",
  email: "care@CrystalFlossdentalclinic.com",
  supportEmail: "appointments@CrystalFlossdentalclinic.com",
  phone: "+91-7052-101-786",
  telephoneHref: "tel:+917052101786",
  priceRange: "$$",
  description:
    "CrystalFloss Dental Clinic in Noida offers personalized family, cosmetic, restorative, pediatric, and emergency dental care with modern technology, transparent guidance, and a comfort-first patient experience.",
  tagline: "Personalized family and cosmetic dentistry for confident smiles in Noida.",
  address: {
    streetAddress: "1247 Plot No. 39, 15th Phase",
  ...
  socialLinks: [
    "https://www.facebook.com/CrystalFlossdentalclinic",
    "https://www.instagram.com/CrystalFlossdentalclinic",
    "https://x.com/CrystalFlossdental",
    "https://www.youtube.com/@CrystalFlossdentalclinic",
  ],
};
...
export const homepageKeywords = [
  ...
  "cosmetic dentist in Noida",
  "emergency dentist in Noida",
