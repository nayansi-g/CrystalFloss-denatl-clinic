...
const testimonials = [
  {
    id: 1,
    name: "Ananya Sharma",
    role: "Smile makeover patient from Noida",
    image: "/testimonals1.png",
    text: "I wanted a clinic that would explain cosmetic dentistry properly instead of pushing treatment. CrystalFloss made me feel heard, showed me realistic options, and gave me a smile that still feels natural.",
  },
  {
    id: 2,
    name: "Rahul Verma",
...
const quickFacts = [
  ...
  "Trusted dental clinic for families across Noida",
];
    ...
    <div className="card-surface relative h-full p-7">
      ...
      <div className="flex items-center gap-4">
        <div className="h-16 w-16 overflow-hidden rounded-full border border-[#d6e4df]">
          <Image
            src={item.image}
            alt={`${item.name} reviewing care at CrystalFloss Dental Clinic`}
            width={64}
            height={64}
