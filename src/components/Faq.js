...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Yes. CrystalFloss Dental Clinic supports family dental care, smile makeovers, restorative treatment, and preventive visits in one location, making it easier to manage care for everyone in your home.",
  },
  {
      ...
      <div className="site-shell grid overflow-hidden rounded-[2rem] lg:grid-cols-[0.95fr_1.05fr]">
        <div className="bg-[#16313b] px-7 py-10 text-white sm:px-10  lg:py-14">
          ...
          <p className="mt-3 max-w-[520px] text-[16px] leading-6 text-white/72">
            ...
            they are searching for the best dentist in Noida, emergency dental help, or a comfortable clinic for
            their family.
          </p>
