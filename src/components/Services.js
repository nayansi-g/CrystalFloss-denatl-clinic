    ...
    <section className="section-shell px-4 sm:px-6 md:px-8">
      <div className="site-shell">
        <div className="section-heading">
          <p className="section-kicker">Dental services in Noida</p>
          <h2 className="section-title">Personalized treatment for the smile you have and the smile you want.</h2>
          <p className="section-copy mx-auto max-w-4xl">
            ...
            emergency dentist in Noida, our team creates care plans that match your goals, schedule, and comfort level.
          </p>
        </div>
        ...
        <div className="mt-14 grid items-center gap-8 lg:grid-cols-[1.05fr_0.9fr]">
          <div className="grid gap-5 sm:grid-cols-2">
            {services.map((service) => {
              ...
              return (
                <div key={service.title} className="card-surface p-4">
          ...
          <div className="relative">
            ...
            <div className="card-surface relative overflow-hidden rounded-[2rem] p-4">
              ...
              <div className="relative overflow-hidden rounded-[1.6rem] bg-[#e8f2ee]">
                <Image
                  src="/services.png"
              ...
              <div className="absolute bottom-8 left-8 max-w-[260px] rounded-[1.4rem] bg-[#16313b] px-5 py-5 text-white shadow-[0_18px_40px_rgba(22,49,59,0.18)]">
                <p className="text-xs font-bold uppercase tracking-[0.18em] text-[#8fe8e2]">
                  Local SEO focus
                </p>
                <p className="mt-2 text-lg font-semibold leading-7">
                  Family dentistry, smile design, and emergency dental appointments in Noida.
                </p>
              </div>
            </div>
          </div>
